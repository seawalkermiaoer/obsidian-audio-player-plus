...
// sfc-script:E:\best\obsidian-audio-player-plus\src\components\App.vue?type=script
...
var AudioComment_default = defineComponent({
  ...
  methods: {
    handleClick() {
      var _a2, _b, _c, _d;
      if (((_a2 = this.cmt) == null ? void 0 : _a2.endTimeNumber) !== void 0) {
        this.$emit("play-segment", (_b = this.cmt) == null ? void 0 : _b.startTimeNumber, (_c = this.cmt) == null ? void 0 : _c.endTimeNumber);
      } else {
        this.$emit("move-playhead", (_d = this.cmt) == null ? void 0 : _d.startTimeNumber);
      }
    },
    emitRemove() {
...
// sfc-template:E:\best\obsidian-audio-player-plus\src\components\AudioComment.vue?type=template
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("span", _hoisted_1, toDisplayString((_a2 = _ctx.cmt) == null ? void 0 : _a2.startTimeString) + "~" + toDisplayString((_b = _ctx.cmt) == null ? void 0 : _b.endTimeString), 1),
    createBaseVNode("span", _hoisted_2, toDisplayString((_c = _ctx.cmt) == null ? void 0 : _c.content), 1)
  ]);
}
...
AudioComment_default.__scopeId = "data-v-3818d76b";
...
var App_default = defineComponent({
  ...
  computed: {
    ...
    commentsSorted() {
      return this.comments.sort((x, y) => x.startTimeNumber - y.startTimeNumber);
    }
  },
  methods: {
    getSectionInfo() {
    ...
    timeUpdateHandler() {
      ...
      if (this.isCurrent()) {
        ...
        const nextCommencts = this.commentsSorted.filter((x) => {
          var _a3;
          return ((_a3 = this.audio) == null ? void 0 : _a3.currentTime) >= x.startTimeNumber;
        });
    ...
    getComments() {
      ...
      const cmts = cmtLines.map((x, i) => {
        ...
        let endTimeNumber = void 0;
        let endTimeString = void 0;
        let content = split[1];
  ...
  mounted() {
    ...
    this.button1 = this.$refs.playpause1;
    this.setBtnIcon("play");
...
// sfc-template:E:\best\obsidian-audio-player-plus\src\components\App.vue?type=template
var _hoisted_12 = {
  ...
  return openBlock(), createElementBlock("div", _hoisted_12, [
    ...
    withDirectives(createBaseVNode("div", _hoisted_10, [
      ...
      createBaseVNode("div", {
        ...
        onClick: _cache[4] || (_cache[4] = (...args) => _ctx.togglePlay && _ctx.togglePlay(...args)),
        ref: "playpause1"
      }, null, 512),
      createBaseVNode("div", {
        class: "playpause seconds",
        onClick: _cache[5] || (_cache[5] = ($event) => _ctx.setPlayheadSecs(_ctx.currentTime + 5)),
        ref: "add5"
      }, " +5s ", 512)
    ], 512), [
      [vShow, _ctx.smallSize]
    ...
    _ctx.showInput ? (openBlock(), createElementBlock("div", _hoisted_11, [
      withDirectives(createBaseVNode("input", {
        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.newComment = $event),
        onKeydown: [
          _cache[7] || (_cache[7] = withKeys(($event) => {
            _ctx.showInput = false;
            _ctx.newComment = "";
          }, ["escape"])),
          _cache[8] || (_cache[8] = withKeys((...args) => _ctx.addComment && _ctx.addComment(...args), ["enter"]))
        ],
        type: "text",
        ref: "commentInput"
      }, null, 544), [
        [vModelText, _ctx.newComment]
      ]),
      createBaseVNode("button", {
        onClick: _cache[9] || (_cache[9] = (...args) => _ctx.addComment && _ctx.addComment(...args))
      }, "Add"),
      createBaseVNode("button", {
    ...
    createBaseVNode("div", _hoisted_122, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.commentsSorted, (cmt) => {
        return openBlock(), createBlock(_component_AudioCommentVue, {
          ...
          onPlaySegment: _ctx.playSegment,
          cmt,
          key: cmt.startTimeString
        }, null, 8, ["class", "onMovePlayhead", "onRemove", "onPlaySegment", "cmt"]);
      }), 128))
    ])
  ]);
}
